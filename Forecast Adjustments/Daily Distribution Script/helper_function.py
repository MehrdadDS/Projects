...
events_weeks = { # distributions we have to copied and applied 
                    2023:
                    {
                        ...
                        'peak'        :                     {2022:[48]},
                        'Week49Distribution':               {2022:[49]},
                        'Week50Distribution':               {2022:[50]},
                        'Week51Distribution':               {2022:[51]},
                        'christmas'    :                    {2022:[52]}
                    },
                     2024:
                    {
                    ...
                    2025:
                    {
                        'New Years Day' :                   {2024:[1]},
                        'family_day'  :                     {2024:[7]},
                        'good_friday' :                     {2024:[14]},
                        'victoria_day':                     {2024:[21]},
                        'St Jean Baptiste Day':             {2023:[26]},
                        'canada_day'  :                     {2023:[27]},
                        'civic_day'   :                     {2023:[32]},
                        'labour_day'  :                     {2023:[36]},
                        'Truth_and_Reconciliation' :        {2023:[27]},
                        'Week_after_T&R':                   {2023:[15]},
                        'thanksgiving':                     {2023:[41]},
                        'rememberance_day':                 {2023:[45]},
                        'peak'        :                     {2023:[48]},
                        'Week49Distribution':               {2023:[49]},
                        'Week50Distribution':               {2023:[50]},
                        'Week51Distribution':               {2023:[51]},
                        'christmas'    :                    {2023:[52]}
                 }
                }
                        ...
                        2023:
                            {
                                ...
                                'Week49Distribution':{           "Week":49   ,"Province":ALL},
                                'Week50Distribution':{           "Week":50   ,"Province":ALL},
                                'Week51Distribution':{           "Week":51   ,"Province":ALL},
                        ...
                        2024:
                            {
                                'New Years Day':{               "Week":1   ,"Province":ALL},
                                'family_day':{                  "Week":8    ,"Province":family_day_provinces},
                                'good_friday':{                 "Week":13   ,"Province":ALL},
                                'victoria_day':{                "Week":21   ,"Province":ALL},
                                'St Jean Baptiste Day':{        "Week":26   ,"Province":['QC']},
                        ...
                        2025:
                            {
                                'New Years Day':{               "Week":1   ,"Province":ALL},
                                'family_day':{                  "Week":8    ,"Province":family_day_provinces},
                                'good_friday':{                 "Week":16   ,"Province":ALL},
                                'victoria_day':{                "Week":21   ,"Province":ALL},
                                'St Jean Baptiste Day':{        "Week":26   ,"Province":['QC']},
                                'canada_day':{                  "Week":27   ,"Province":ALL},
                                'civic_day':{                   "Week":32   ,"Province":civic_provinces},
                                'labour_day':{                  "Week":36   ,"Province":ALL},
                                'Truth_and_Reconciliation':{    "Week":40   ,"Province":ALL},
                                'thanksgiving':{                "Week":42   ,"Province":ALL},
                                'rememberance_day':{            "Week":46   ,"Province":rememberance_provinces},
                                'peak':{                        "Week":48   ,"Province":ALL},
                                'Week49Distribution':{           "Week":49   ,"Province":ALL},
                                'Week50Distribution':{           "Week":50   ,"Province":ALL},
                                'Week51Distribution':{           "Week":51   ,"Province":ALL},
...
def editing_pcl_total_del_stops(daily_forecast_tbl,no_agents_terminals,one_stops_terminals,variables_list=variables_list):
    daily_forecast_tbl = daily_forecast_tbl.dropna()
